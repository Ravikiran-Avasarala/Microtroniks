        ...
        <BottomsheetModal visible={visible}
            ...
            <View style={styles.container}>
                ...
                <Pressable style={[styles.row, styles.justifycontent,styles.alignItems,{marginTop:20}]}>
                    <MText title={`Video Recording`} style={styles.payOption} />
                    <RightArrow />
                </Pressable>

                <View style={{ height: 1, backgroundColor: colors.SEMI_GREEN, width: '100%', marginTop: 10 }} />
                <Pressable style={[styles.row, styles.justifycontent,styles.alignItems,{marginTop:20}]}>
                    <MText title={`Audio Recording`} style={styles.payOption} />
                    <RightArrow />
                </Pressable>
                <View style={{ height: 1, backgroundColor: colors.SEMI_GREEN, width: '100%', marginTop: 10 }} />
                <Pressable style={[styles.row, styles.justifycontent,styles.alignItems,{marginTop:20}]}>
                    <MText title={`Add Images`} style={styles.payOption} />
                    <RightArrow />
                </Pressable>
